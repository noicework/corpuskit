...
<!-- TODO (owner): replace with a real, monitored contact before this repo goes public. -->

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the
community leaders responsible for enforcement at **conduct@[project]** (placeholder - the repository
owner needs to set a real, monitored contact address here). All complaints will be reviewed and
