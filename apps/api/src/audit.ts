...
const codes = [
  ...
  'operator_delete_disabled',
  'domain_removal_unavailable',
...
const fields = {
  ...
  eraseRequested: flag,
  // Records removed by a portal erasure, one field for each kind in `ERASED_RECORD_KINDS`.
  erasedConfiguration: count,
  erasedAliases: count,
  erasedBindings: count,
  erasedLifecycle: count,
  erasedSessions: count,
  erasedInvestigations: count,
  erasedWatches: count,
  erasedSources: count,
  erasedInsights: count,
  erasedSuggestions: count,
  erasedEnrichments: count,
  erasedKgProposals: count,
  erasedBranding: count,
  erasedRouting: count,
  erasedMcpKeys: count,
  erasedAssignments: count,
  erasedAuditEvents: count,
...
const actionFields = {
  ...
  // Counts only: an erasure record names the actor and the slug, never what was erased.
  'portal.erase': [
    'permission',
    'code',
    'count',
